...
Normally, device Recovery tools [should be sensitive](https://source.android.com/devices/tech/ota/sign_builds.html) to `SHA1-Digest`, [but not](https://github.com/corkami/pocs/blob/master/collisions/README.md). So, you can easily change the content of the **[updater-script](https://github.com/xhdix/Mobile-Partition-Format-Tool/raw/master/META-INF/com/google/android/updater-script)** file at the following address:
